...
ARMOR_MAIL       = ArmorType(6, 5.0,  900, 0.10, [MaterialType.Metal])  # chainmail, laminar
ARMOR_PLATE_MAIL = ArmorType(7, 6.0, 1400, 0.05, [MaterialType.Metal])  # splinted chainmail
ARMOR_FULL_PLATE = ArmorType(8, 7.0, 2400, 0.01, [MaterialType.Metal])  # gothic plate

MATERIAL_BONE    = ArmorMaterial('Bone',     1.5,  MaterialType.Mineral)
MATERIAL_CHITIN  = ArmorMaterial('Chitin',   0.75, MaterialType.Mineral)
MATERIAL_IVORY   = ArmorMaterial('Ivory',    1.25, MaterialType.Mineral)
MATERIAL_SHELL   = ArmorMaterial('Shell',    2.0,  MaterialType.Mineral)
MATERIAL_STONE   = ArmorMaterial('Obsidian', 3.0,  MaterialType.Mineral)
MATERIAL_JADE    = ArmorMaterial('Jade',     3.0,  MaterialType.Mineral)
MATERIAL_LEATHER = ArmorMaterial('Leather',  2.0,  MaterialType.Leather)
MATERIAL_LINEN   = ArmorMaterial('Linen',    1.0,  MaterialType.Cloth)
MATERIAL_SILK    = ArmorMaterial('Silk',     0.75, MaterialType.Cloth)
MATERIAL_BRONZE  = ArmorMaterial('Bronze',   1.0,  MaterialType.Metal)
MATERIAL_IRON    = ArmorMaterial('Iron',     1.0,  MaterialType.Metal)
MATERIAL_STEEL   = ArmorMaterial('Steel',    0.75, MaterialType.Metal)
