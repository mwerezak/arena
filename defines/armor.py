...
HIDE_ARMOR = ArmorTemplate('Armor', ARMORTYPE_HIDE, MATERIAL_LEATHER, PATTERN_ARMOR)
IRON_HELMET = ArmorTemplate('Iron Helmet', ARMORTYPE_SCALED, MATERIAL_IRON, PATTERN_HELMET)
...
PADDED_HAUBERK = ArmorTemplate('Hauberk', ARMORTYPE_LAMINATED, MATERIAL_LINEN, PATTERN_HAUBERK)
PADDED_TAILGUARD = ArmorTemplate('Tailguard', ARMORTYPE_LAMINATED, MATERIAL_LINEN, PATTERN_TAILGUARD)

IRON_SCALE_CUIRASS = ArmorTemplate('Scale Cuirass', ARMORTYPE_SCALED, MATERIAL_IRON, PATTERN_CUIRASS)
IRON_SCALE_HAUBERK = ArmorTemplate('Scale Hauberk', ARMORTYPE_SCALED, MATERIAL_IRON, PATTERN_HAUBERK)
