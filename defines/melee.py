# Default Specials - Anyone can use

# MaxDamageSpecial - (offensive) deal max damage instead of rolling
# HitLocationSpecial - (offensive) attack hit location of choice instead of random
# SecondaryAttackSpecial - (both) simultaneous attack with an offhand or natural weapon, do not roll for criticals
# ImproveParrySpecial - (defensive) ignore weapon force difference for defence
