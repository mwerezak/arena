...
SHIELD_BUCKLER = Weapon(
    ...
    melee_attacks= [
        MeleeAttackTemplate('Bash', (REACH_SHORT, REACH_SHORT), FORCE_TINY, DamageType.Bludgeon, dice(1, 3), -dice(1, 3), traits=[CannotDefendTrait()], criticals=[KnockdownCritical]),
    ]
)
