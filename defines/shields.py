...
SHIELD_BUCKLER = Weapon(
    ...
    melee_attacks= [
        MeleeAttackTemplate('Bash', (REACH_SHORT, REACH_SHORT), FORCE_TINY, DamageType.Bludgeon, dice(1, 3), -dice(1, 3)),
    ]
)
...
SHIELD_SMALL = Weapon(
    ...
    melee_attacks= [
        MeleeAttackTemplate('Bash', (REACH_SHORT, REACH_SHORT), FORCE_SMALL, DamageType.Bludgeon, dice(1, 4), -dice(1, 3)),
    ]
)
